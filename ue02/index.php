...
/**
 * Check if a string is a valid e-mail address. Only some existing top-level-domains are validated, has to be updated if
 * a new one is registered.
 * @see http://www.regular-expressions.info/email.html Detailed information about this regular expression.
 * @param string $string The string that is to be checked for an e-mail address.
 * @return bool Returns true if regular expression is matched and the string is a valid e-mail address.
 */
